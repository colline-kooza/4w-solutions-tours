          ...
          {forgotPasswordLink && (
            <div className="text-sm">
              <Link
                ...
                className="font-medium text-[#34e0a1] hover:text-rose-500"
              >
                Forgot password?
              </Link>
            </div>
      ...
      <div className="mt-2">
        <div className="relative rounded-md ">
          ...
          <input
            ...
            className={cn(
              "block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#34e0a1] sm:text-sm sm:leading-6 text-sm",
